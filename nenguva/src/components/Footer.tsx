    ...
    <footer className="w-full">
      ...
      <div className="bg-[#37004b] text-white text-sm">
        <div className="max-w-7xl mx-auto px-6 py-16 grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          {/* Divider (Only visible on medium+ screens) */}
          <div className="hidden md:block border-r border-white/30 h-full mx-auto" />

          {/* -------- Info Block (Right Section) -------- */}
          <div className="flex flex-col gap-4 text-sm md:col-span-1 leading-relaxed">
            <p>
            ...
            <p>
              Rated <strong>Great</strong> based on 79,000+ customer reviews on
              TrustPilot.
            </p>
